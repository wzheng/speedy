...
If that node does not lie on an attack edge with the Sybil region, then their is a high probability
all of the nodes contacted will stay within the honest region.
